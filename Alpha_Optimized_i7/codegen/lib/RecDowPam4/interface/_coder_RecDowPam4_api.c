...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "RecDowPam4",
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *Ix1, const
  ...
  u_size[2])
{
  ...
  mxSetData((mxArray *)m3, (void *)u_data);
  ...
  char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(Ix1), &thisId, y);
...
void RecDowPam4_api(const mxArray *prhs[20], const mxArray *plhs[33])
{
  ...
  emxInit_real_T(&st, &Ix1, 2, true);
  emxInit_real_T(&st, &TxDataMat, 2, true);
  emxInit_real_T(&st, &Ix, 2, true);
  emxInit_real_T(&st, &TxData, 2, true);
  emxInit_real_T(&st, &IxRecDef, 2, true);
  emxInit_real_T(&st, &IxRec, 2, true);
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);
  prhs[14] = emlrtProtectR2012b(prhs[14], 14, false, -1);

  /* Marshall function inputs */
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "Ix1", Ix1);
  T = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "T");
  Ta = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "Ta");
  MaxNumStag = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "MaxNumStag");
  StuffSampels = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "StuffSampels");
  NumAmosCP = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "NumAmosCP");
  NPPB = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[6]), "NPPB");
  CurTesSiz = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[7]), "CurTesSiz");
  Nb4Pam = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[8]), "Nb4Pam");
  IntervalStep = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[9]), "IntervalStep");
  MinDist = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[10]), "MinDist");
  DecLevDef1 = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[11]), "DecLevDef1");
  DecLevDef2 = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[12]), "DecLevDef2");
  DecLevDef3 = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[13]), "DecLevDef3");
  emlrt_marshallIn(&st, emlrtAlias(prhs[14]), "TxDataMat", TxDataMat);
  ThisCarr = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[15]), "ThisCarr");
  IfftOrSum = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[16]), "IfftOrSum");
  AddCP = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[17]), "AddCP");
  SyncPeriod = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[18]), "SyncPeriod");
  DecMod = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[19]), "DecMod");
...
/*
 * File trailer for _coder_RecDowPam4_api.c
 *
 * [EOF]
 */
