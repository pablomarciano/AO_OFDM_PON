...
MAKEFILE = RecDowDepsk_mex.mk

include RecDowDepsk_mex.mki
...
SRC_FILES =  \
	...
	xor.c \
	sum.c \
	_coder_RecDowDepsk_info.c \
	_coder_RecDowDepsk_api.c \
	_coder_RecDowDepsk_mex.c \
	RecDowDepsk_emxutil.c

MEX_FILE_NAME_WO_EXT = RecDowDepsk_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\RecDowDepsk"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\RecDowDepsk/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
