/*
 * RecDowPam4_emxutil.h
 *
 * Code generation for function 'RecDowPam4_emxutil'
 *
 */

#ifndef RECDOWPAM4_EMXUTIL_H
#define RECDOWPAM4_EMXUTIL_H
...
/* End of code generation (RecDowPam4_emxutil.h) */
