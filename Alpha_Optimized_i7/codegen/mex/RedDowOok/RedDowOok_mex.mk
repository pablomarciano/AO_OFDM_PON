...
MAKEFILE = RedDowOok_mex.mk

include RedDowOok_mex.mki
...
SRC_FILES =  \
	...
	xor.c \
	sum.c \
	_coder_RedDowOok_info.c \
	_coder_RedDowOok_api.c \
	_coder_RedDowOok_mex.c \
	RedDowOok_emxutil.c

MEX_FILE_NAME_WO_EXT = RedDowOok_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\RedDowOok"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\RedDowOok/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
