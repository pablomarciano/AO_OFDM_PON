...
static emlrtRTEInfo u_emlrtRTEI = { 53, 23, "assertValidSizeArg",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\eml\\+coder\\+internal\\assertValidSizeArg.m"
};

static emlrtRTEInfo v_emlrtRTEI = { 59, 15, "assertValidSizeArg",
  "C:\\Program Files\\MATLAB\\R2016a\\toolbox\\eml\\eml\\+coder\\+internal\\assertValidSizeArg.m"
};
...
void assertValidSizeArg(const emlrtStack *sp, real_T varargin_1)
{
  ...
  if (2.147483647E+9 >= b_varargin_1) {
    ...
    emlrtErrorWithMessageIdR2012b(sp, &v_emlrtRTEI, "Coder:MATLAB:pmaxsize", 0);
  }
}
